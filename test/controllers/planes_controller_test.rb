...
class PlanesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create plane" do
    assert_difference('Plane.count') do
      post planes_url, params: { plane: { aq_date: @plane.aq_date, model: @plane.model, name: @plane.name } }
    end
  ...
  test "should update plane" do
    patch plane_url(@plane), params: { plane: { aq_date: @plane.aq_date, model: @plane.model, name: @plane.name } }
